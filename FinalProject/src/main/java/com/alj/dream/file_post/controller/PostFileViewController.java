...
@Controller
public class PostFileViewController {
	...
	public ResponseEntity<byte[]> getFile(HttpServletRequest request, String fileName){
		...
		File file = new File(request.getSession().getServletContext().getRealPath("/resources/files/post/attachfiles/") + fileName);
	...
	@GetMapping(value="/post/download", produces=MediaType.APPLICATION_OCTET_STREAM_VALUE)
	@ResponseBody
	public ResponseEntity<Resource> downloadFile(
		...
		String path = request.getSession().getServletContext().getRealPath("/resources/files/post/attachfiles/") + fileName;
