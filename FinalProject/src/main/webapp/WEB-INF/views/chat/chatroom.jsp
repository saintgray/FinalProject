...
<!-- chatRoom의 Header--------------------------------------------------------------------------------------------- -->
	...
	<h3 class="fs-5"><a style="color:#FCA106" href="${pageContext.request.contextPath}/member/profile/main?m_idx=${reciever}">${recieverInfo.m_nm}</a> 님의 프로필 보기</h3>
	</c:if>
	...
	<!-- 후기쓰기 -->
	<button type="button" onclick="review()" id="reviewing">후기 쓰기</button>
		  ...
		  <div class="modal-dialog modal-dialog-centered">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		         	...
		         	<div>
						<textarea class="form-control" rows="5" id="comment" name="text" placeholder="리뷰를 작성해주세요."></textarea>
					</div>
		      </div>
